...
import (
	...
	"os"
	"strconv"
	"tg-example/pkg/clients/service2/cb"
	"tg-example/pkg/clients/service2/hasher"
...
func (cli *ClientJsonRPC) Service2() *ClientService2 {
	return &ClientService2{ClientJsonRPC: cli}
}
