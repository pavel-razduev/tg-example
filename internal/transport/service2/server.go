...
import (
	...
	"io"
	"os"
	"tg-example/internal/transport/service2/tracer"
...
func (srv *Server) WithLog() *Server {
	if srv.httpService2 != nil {
		srv.httpService2 = srv.Service2().WithLog()
	}
	return srv
}
...
func (srv *Server) WithTrace(ctx context.Context, appName string, endpoint string, attributes ...attribute.KeyValue) *Server {
	...
	if srv.httpService2 != nil {
		srv.httpService2 = srv.Service2().WithTrace()
	}
	return srv
}
...
func (srv *Server) WithMetrics() *Server {
	...
	if srv.httpService2 != nil {
		srv.httpService2 = srv.Service2().WithMetrics()
	}
	return srv
}

func (srv *Server) Service2() *httpService2 {
	return srv.httpService2
}
