...
import (
	...
	"io"
	"os"
	"tg-example/internal/transport/tracer"
...
type Server struct {
	...
	httpExampleService *httpExampleService
...
func (srv *Server) WithLog() *Server {
	if srv.httpExampleService != nil {
		srv.httpExampleService = srv.ExampleService().WithLog()
	}
	return srv
}
...
func (srv *Server) WithTrace(ctx context.Context, appName string, endpoint string, attributes ...attribute.KeyValue) *Server {
	...
	if srv.httpExampleService != nil {
		srv.httpExampleService = srv.ExampleService().WithTrace()
	}
	return srv
}
...
func (srv *Server) WithMetrics() *Server {
	...
	if srv.httpExampleService != nil {
		srv.httpExampleService = srv.ExampleService().WithMetrics()
	}
	return srv
}

func (srv *Server) ExampleService() *httpExampleService {
	return srv.httpExampleService
}
